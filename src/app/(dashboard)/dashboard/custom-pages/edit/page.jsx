...
export default function EditCustomPage() {
  ...
  const fetchPageDetails = async () => {
    try {
      const response = await fetch(`/api/custom-pages/details?id=${pageId}`);
      ...
      if (data.status === 200) {
        setFormData({
          ...
          showInFooter: data.data.showInFooter ?? true,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append("id", pageId);
      ...
      const response = await fetch("/api/custom-pages/update", {
        method: "PUT",
        body: formDataToSend,
      });
          ...
          <div className="grid gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Edit the title and URL slug for your page
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Edit and format your page content using the rich text editor
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
