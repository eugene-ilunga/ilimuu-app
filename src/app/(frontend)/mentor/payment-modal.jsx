...
export default function PaymentModal({
  ...
  const [selectedMethod, setSelectedMethod] = useState(null)
    ...
    try {
      ...
      formData.append("package_id", selectPackage._id);
      ...
      <DialogContent className="w-[95vw] max-w-[425px] sm:max-w-[500px] max-h-[90vh] p-0 overflow-hidden">
        <div className="flex flex-col max-h-[90vh]">
          <DialogHeader className="px-4 sm:px-6 py-4 border-b">
            <DialogTitle className="text-lg sm:text-xl font-semibold">Checkout</DialogTitle>
          </DialogHeader>

          <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4">
            <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
              <div className="mb-6">
                <p className="text-base sm:text-lg font-medium mb-3 sm:mb-4">Payment Methods</p>
              ...
              <div className="border-t pt-4">
                <p className="text-base sm:text-lg font-medium mb-4">Billing Details</p>

                <div className="space-y-2 border-t border-b py-3">
                  <div className="flex items-center justify-between">
                    <p className="text-sm font-medium text-gray-900">Subtotal</p>
                    <p className="text-sm font-semibold text-gray-900">${selectPackage?.price}</p>
                  </div>
                  <div className="flex items-center justify-between">
                ...
                <div className="mt-3 flex items-center justify-between">
                  <p className="text-base sm:text-lg font-medium text-gray-900">Total</p>
                  <p className="text-lg sm:text-xl font-semibold text-gray-900">${selectPackage?.price}</p>
                </div>
              </div>
            </div>
          </div>
