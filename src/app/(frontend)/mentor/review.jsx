...
export default function MentorReviews({ mentorId }) {
  ...
  const fetchMentorReviewData = async () => {
    try {
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        {reviewData?.mentorReviews?.length > 0 ? (
          <div className="space-y-6">
            {reviewData.mentorReviews.map((review) => (
              <Card key={review._id} className="shadow-sm hover:shadow-md transition-shadow duration-200 border-0">
