...
import blogImg1 from "../../public/assets/blog-image/blog1.png";
import blogImg2 from "../../public/assets/blog-image/blog2.png";
import blogImg3 from "../../public/assets/blog-image/blog3.png";
        ...
        <Card className="w-full rounded-2xl overflow-hidden  transition-all duration-300 hover:shadow-xl">
          <Link href="">
            <CardHeader className="p-0 relative">
              ...
              <h4
                alt=""
                className=" text-md px-4  py-2 bg-yellow-400 text-black font-bold  absolute -bottom-4 right-0 object-cover  rounded-bl-2xl rounded-tl-2xl "
              >
                29 oct 2024
              </h4>
            </CardHeader>
            <CardContent className="mt-5 pb-2 px-5">
              ...
              <p className="mt-3 mb-3 leading-7 text-gray-500 text-md">In this article, I’ll explain the two rules I followed to become a straight-A student. If you take my advice, you’ll get better grades and lead a more ...</p>
            </CardContent>
          </Link>
        </Card>
        <Card className="w-full rounded-2xl overflow-hidden  transition-all duration-300 hover:shadow-xl">
