...
const FeaturedBootcamp = () => {
  ...
  const handleEnrollClick = (e, bootcamp) => {
    e.stopPropagation();
    ...
    <div className="bg-purple-50 w-full pb-5 lg:pb-20">
      <div className="container mx-auto px-8 py-8 ">
        ...
        <div className='relative lg:w-1/2 lg:pr-20'>
						...
						<InfoTitle
							heading={"An Intensive Bootcamps Design To Transform Your Skills."}
						>
						</InfoTitle>
					</div>
          <div className="flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {bootcamps.map((bootcamp) => {
            ...
            return (
              <Card 
                key={bootcamp._id} 
                className="group hover:shadow-xl transition-all duration-300 cursor-pointer border-0 shadow-md overflow-hidden flex flex-col h-full"
              >
                <div onClick={() => handleBootcampClick(bootcamp)} className="flex flex-col h-full">
                  ...
                  <CardFooter className="p-4 pt-0 flex items-center justify-between mt-auto border-t border-gray-100">
                    ...
                    {/* Enroll Button */}
                    {bootcamp.is_application_open && bootcamp.available_spots > 0 && (
                      <Button
                        onClick={(e) => handleEnrollClick(e, bootcamp)}
...
export default FeaturedBootcamp;
