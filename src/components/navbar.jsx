      ...
      <div className=" container flex llg:flex lg:flex-wrap items-center justify-between sm:px-10 px-6 py-3 lg:gap-y-4 gap-y-6 gap-x-4 w-full ">
        ...
        <div className="navMenu lg:block md:block hidden">
          <ul className="flex gap-5">
            ...
            <Link href={"/post-feed"}>
              <li className="cursor-pointer text-bold hover:text-[#007bff] text-lg relative inline-block">
                Communauté
                <Badge className="absolute -top-2 -right-4 bg-gradient-to-r from-[#FF710B] to-[#FF8832] text-white border-0 text-[8px] px-1 py-0 font-bold rounded-full min-w-[24px] h-4 flex items-center justify-center animate-pulse">
                  NOUVEAU
                </Badge>
              </li>
            </Link>
          ...
          <div className=" flex items-center space-x-8 max-md:ml-auto">
                    ...
                    <div className="flex flex-col h-full">
                      ...
                      <div className="px-6 py-4 border-b border-gray-100">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                          {cartData.data.items.length}{" "}
                          {cartData.data.items.length === 1 ? "article" : "articles"}
                        </p>
                      </div>
            ...
            {user.token ? (
                    ...
                    <ul className="absolute block shadow-lg bg-white py-2 z-[1000] min-w-full w-max rounded-lg max-h-96 overflow-auto">
                      <Link href="/profile">
                        <li className="capitalize py-2.5 px-5 flex items-center hover:bg-gray-100 text-[#333] text-sm cursor-pointer">
                          ...
                          {user.role === "admin" ? "Profil Admin" : user.role === "instructor" ? "Profil Formateur" : "Profil"}
                        </li>
                      </Link>
                      ...
                      <Link href="/profile?tab=mentors">
                        <li className="py-2.5 px-5 flex items-center hover:bg-gray-100 text-[#333] text-sm cursor-pointer">
                          <UserCheck className="w-4 h-4 mr-3" />
                          Mentor Réservé
                        </li>
                      </Link>
                      <Link href="/profile?tab=bootcamps">
                        <li className="py-2.5 px-5 flex items-center hover:bg-gray-100 text-[#333] text-sm cursor-pointer">
              ...
              <div className="flex gap-1 rounded-full bg-[--primary] py-3 px-6 text-gray-100 text-sm">
                <Link href="/login">
                  <h5 className="">Connexion</h5>
                </Link>
                /
                <Link href="/register">
                  <h5 className="">Inscription</h5>
                </Link>
              </div>
            )}
          </div>
