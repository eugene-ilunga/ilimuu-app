...
import { Star, CalendarDays, Clock, ArrowRight, ArrowLeft, Users, LucideGavel, BookText } from "lucide-react";
				...
				<div className="lg:flex justify-between items-center text-left  lg:pt-10 pt-0 pb-10">
					...
					<div className='relative lg:w-1/2 lg:pr-20'>
						...
						<div className="absolute top-6 right-48">
							<Image className='lg:block hidden w-36 h-16' alt='' src={textCircle}></Image>
						</div>
						<InfoTitle
