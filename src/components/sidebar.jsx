...
export default function Sidebar({ user }) {
  ...
  const [bootcampSubmenuOpen, setBootcampSubmenuOpen] = useState(false);
  ...
  const toggleBootcampSubmenu = () => {
    setBootcampSubmenuOpen(!bootcampSubmenuOpen);
  };
  ...
  const bootcampLinks = "/dashboard/bootcamp";
  const bootcampAddLinks = "/dashboard/bootcamp/add-new";
  const bootcampManageLinks = "/dashboard/bootcamp/";
  ...
  const bootcampSalesLinks = "/dashboard/sales-report/bootcamp";
        ...
        <div className="flex h-fit max-h-screen overflow-y-scroll flex-col gap-2 mt-3 mx-1" style={{ scrollbarWidth: "none" }}>
          <div className="flex-1">
            <nav className="grid items-start px-2 text-sm font-medium lg:px-4">
              ...
              <div>
                <button
                  onClick={toggleBootcampSubmenu}
                  className={`flex  w-full items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === "/dashboard/bootcamp"
                    ? "bg-muted text-primary"
                    : "text-muted-foreground hover:text-primary"
                    }`}
                >
                  ...
                  Bootcamp
                  <ChevronDown
                    className={`h-4 w-4 ml-auto transition-transform ${bootcampSubmenuOpen ? "rotate-180" : ""
                      }`}
                  />
                </button>
                ...
                {bootcampSubmenuOpen && (
                  <div className="ml-8 flex flex-col gap-1">
                    <Link
                      href="/dashboard/bootcamp/add-new"
                      onClick={() => setActiveLink("/dashboard/bootcamp/add-new")}
                      className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === "/dashboard/bootcamp/add-new"
                        ? "bg-muted text-primary"
                        : "text-muted-foreground hover:text-primary"
                        }`}
                    >
                    ...
                    <Link
                      ...
                      onClick={() => setActiveLink("/dashboard/bootcamp/")}
                      className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === "/dashboard/bootcamp/"
                        ? "bg-muted text-primary"
                        : "text-muted-foreground hover:text-primary"
                        }`}
                    >
                    ...
                    <Link
                      href="/dashboard/bootcamp/phases"
                      onClick={() => setActiveLink("/dashboard/bootcamp/phases")}
                      className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === "/dashboard/bootcamp/phases"
                        ? "bg-muted text-primary"
                        : "text-muted-foreground hover:text-primary"
                        }`}
                    >
                    ...
                    <Link
                      href="/dashboard/bootcamp/schedule"
                      onClick={() => setActiveLink("/dashboard/bootcamp/schedule")}
                      className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === "/dashboard/bootcamp/schedule"
                        ? "bg-muted text-primary"
                        : "text-muted-foreground hover:text-primary"
                        }`}
                    >
                    ...
                    <Link
                      ...
                      onClick={() => setActiveLink("/dashboard/bootcamp/enrollments")}
                      className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === "/dashboard/bootcamp/enrollments"
                        ? "bg-muted text-primary"
                        : "text-muted-foreground hover:text-primary"
                        }`}
                    >
                    ...
                    <Link
                      href="/dashboard/bootcamp/analytics"
                      onClick={() => setActiveLink("/dashboard/bootcamp/analytics")}
                      className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === "/dashboard/bootcamp/analytics"
                        ? "bg-muted text-primary"
                        : "text-muted-foreground hover:text-primary"
                        }`}
                    >
              ...
              {(user.role === "admin" || user.role === "instructor") && (
                <Link
                  href="/dashboard/bootcamp/question-exam"
                  onClick={() => setActiveLink("/dashboard/bootcamp/question-exam")}
                  className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === "/dashboard/bootcamp/question-exam"
                    ? "bg-muted text-primary"
                    : "text-muted-foreground hover:text-primary"
                    }`}
                >
              ...
              {(user.role === "admin" || user.role === "instructor") && (
                <Link
                  ...
                  onClick={() => setActiveLink("/dashboard/certificates")}
                  className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === "/dashboard/certificates"
                    ? "bg-muted text-primary"
                    : "text-muted-foreground hover:text-primary"
                    }`}
                >
              ...
              <div>
                ...
                {salesReportSubmenuOpen && (
                  <div className="ml-8 flex flex-col gap-1">
                    ...
                    <Link
                      href={bootcampSalesLinks}
                      onClick={() => setActiveLink(bootcampSalesLinks)}
                      className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === bootcampSalesLinks
                        ? "bg-muted text-primary"
                        : "text-muted-foreground hover:text-primary"
                        }`}
                    >
              ...
              {user.role === "admin" && (
                <div>
                  <button
                    ...
                    className={`flex w-full items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === "/dashboard/other"
                      ? "bg-muted text-primary"
                      : "text-muted-foreground hover:text-primary"
                      }`}
                  >
                    ...
                    Other
                    <ChevronDown
                      className={`h-4 w-4 ml-auto transition-transform ${otherSubmenuOpen ? "rotate-180" : ""
                        }`}
                    />
                  </button>
                  {otherSubmenuOpen && (
                    <div className="ml-8 flex flex-col gap-1">
                      <Link
                        ...
                        onClick={() => setActiveLink("/dashboard/about-page")}
                        className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === "/dashboard/about-page"
                          ? "bg-muted text-primary"
                          : "text-muted-foreground hover:text-primary"
                          }`}
                      >
                      ...
                      <Link
                        ...
                        onClick={() => setActiveLink("/dashboard/team-members")}
                        className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === "/dashboard/team-members"
                          ? "bg-muted text-primary"
                          : "text-muted-foreground hover:text-primary"
                          }`}
                      >
                      ...
                      <Link
                        ...
                        onClick={() => setActiveLink("/dashboard/mobile-app")}
                        className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === "/dashboard/mobile-app"
                          ? "bg-muted text-primary"
                          : "text-muted-foreground hover:text-primary"
                          }`}
                      >
                      ...
                      <Link
                        href="/dashboard/faq"
                        onClick={() => setActiveLink("/dashboard/faq")}
                        className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === "/dashboard/faq"
                          ? "bg-muted text-primary"
                          : "text-muted-foreground hover:text-primary"
                          }`}
                      >
                      ...
                      <Link
                        href="/dashboard/custom-pages"
                        onClick={() => setActiveLink("/dashboard/custom-pages")}
                        className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === "/dashboard/custom-pages"
                          ? "bg-muted text-primary"
                          : "text-muted-foreground hover:text-primary"
                          }`}
                      >
                      ...
                      <Link
                        href="/dashboard/video-section"
                        onClick={() => setActiveLink("/dashboard/video-section")}
                        className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${activeLink === "/dashboard/video-section"
                          ? "bg-muted text-primary"
                          : "text-muted-foreground hover:text-primary"
                          }`}
                      >
